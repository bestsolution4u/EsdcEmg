                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            RippleComponent(
                              onClick: () {
                                String phone = AppLocalization.of(context)
                                    .trans(widget.phone1);
                                if (phone.startsWith("("))
                                  phone = "1-" +
                                      phone
                              ...
                              child: Text(
                                AppLocalization.of(context)
                                    .trans(widget.phone1),
                                style:
                                    TextStyle(color: Styles.blue, fontSize: 16),
                                textScaleFactor:
                                    ScreenUtil.calcTextScaleFactor(context),
                              ),
                            ),
                            ...
                            RippleComponent(
                              onClick: () {
                                if (widget.website ==
                                    ...
                                    widget.website == 'site_contact_psc') {
                                  launch(AppLocalization.of(context)
                                      .trans(widget.website));
                                } else {
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
