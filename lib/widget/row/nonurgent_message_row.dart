        ...
        child: Row(
          ...
          children: [
            Expanded(child: Row(
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                Flexible(child: Text(AppLocalization.currentLanguage == 'fr' ? widget.message.titleFr : widget.message.title, style: TextStyle(color: read ? Colors.black : Styles.purple, fontSize: 14, fontWeight: read ? FontWeight.w400 : FontWeight.w700),)),
                SizedBox(width: 5,),
                !read ? Container(
                  height: 10,
                  width: 10,
