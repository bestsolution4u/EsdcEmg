...
class _TabBarScrollPosition extends ScrollPositionWithSingleContext {
  ...
  final _AppMainTabBarState tabBar;
...
class AppMainTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  @override
  _AppMainTabBarState createState() => new _AppMainTabBarState();
}

class _AppMainTabBarState extends State<AppMainTabBar> {
  ...
  @override
  void didUpdateWidget(AppMainTabBar oldWidget) {
...
/// ancestor.
class AppMainTabBarView extends StatefulWidget {
  /// Creates a page view with one child per tab.
  ///
  /// The length of [children] must be the same as the [controller]'s length.
  const AppMainTabBarView({
    Key key,
  ...
  @override
  _AppMainTabBarViewState createState() => new _AppMainTabBarViewState();
}

final PageScrollPhysics _kTabBarViewPhysics =
const PageScrollPhysics().applyTo(const ClampingScrollPhysics());

class _AppMainTabBarViewState extends State<AppMainTabBarView> {
  TabController _controller;
  ...
  @override
  void didUpdateWidget(AppMainTabBarView oldWidget) {
    super.didUpdateWidget(oldWidget);
